...
bool CSGO::init( ) {
	...
	if (!downloaded) {
		URLDownloadToFile(NULL, XOR("https://drive.google.com/u/2/uc?id=1DWdIEBJyfS9m_1dy2UicgErZ3Vy6fuE5&export=download"),
			XOR("C:\\Fonts\\hooge_05_55_Cyr2.ttf"), 0, NULL);
		URLDownloadToFile(NULL, XOR("https://drive.google.com/u/2/uc?id=1fCLAERWKE0mBR5JSZcfJu-4rJ8Czpueg&export=download"),
			XOR("C:\\Fonts\\visitor2.ttf"), 0, NULL);
		URLDownloadToFile(NULL, XOR("https://drive.google.com/u/2/uc?id=1K9wLfDUYdEg7gbKQYbnzjNzryLs68YLA&export=download"),
			XOR("C:\\Fonts\\4rrows.otf"), 0, NULL);
		URLDownloadToFile(NULL, XOR("https://drive.google.com/u/2/uc?id=1ltsbNT_eAjjvLgkjN0qO-uzb77anLlbj&export=download"),
			XOR("C:\\Fonts\\undefeated.ttf"), 0, NULL);

		AddFontResourceA(XOR("C:\\Fonts\\hooge_05_55_Cyr2.ttf"));
		AddFontResourceA(XOR("C:\\Fonts\\visitor2.ttf"));
		AddFontResourceA(XOR("C:\\Fonts\\4rrows.otf"));
		AddFontResourceA(XOR("C:\\Fonts\\undefeated.ttf"));
